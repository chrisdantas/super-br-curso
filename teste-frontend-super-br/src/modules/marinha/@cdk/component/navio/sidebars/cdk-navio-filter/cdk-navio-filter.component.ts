...
@Component({
    selector: 'cdk-navio-filter',
    templateUrl: './cdk-navio-filter.component.html',
    styleUrls: ['./cdk-navio-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkNavioFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-navio-filter').close();
    }
