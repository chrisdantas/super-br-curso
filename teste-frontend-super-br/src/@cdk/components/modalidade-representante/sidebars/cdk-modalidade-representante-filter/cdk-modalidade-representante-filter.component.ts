...
@Component({
    selector: 'cdk-modalidade-representante-filter',
    templateUrl: './cdk-modalidade-representante-filter.component.html',
    styleUrls: ['./cdk-modalidade-representante-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeRepresentanteFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-representante-filter').close();
    }
