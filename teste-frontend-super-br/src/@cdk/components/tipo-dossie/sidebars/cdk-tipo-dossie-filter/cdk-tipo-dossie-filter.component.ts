...
@Component({
    selector: 'cdk-tipo-dossie-filter',
    templateUrl: './cdk-tipo-dossie-filter.component.html',
    styleUrls: ['./cdk-tipo-dossie-filter.component.scss'],
    animations: cdkAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None
})
export class CdkTipoDossieFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('generoRelatorio').value) {
            andXFilter.push({'especieRelatorio.generoRelatorio.id': `eq:${this.form.get('generoRelatorio').value.id}`});
        }

        if (this.form.get('especieRelatorio').value) {
            andXFilter.push({'especieRelatorio.id': `eq:${this.form.get('especieRelatorio').value.id}`});
        }
