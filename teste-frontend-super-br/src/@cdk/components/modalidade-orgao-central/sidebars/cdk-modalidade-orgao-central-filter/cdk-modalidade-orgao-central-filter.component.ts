...
@Component({
    selector: 'cdk-modalidade-orgao-central-filter',
    templateUrl: './cdk-modalidade-orgao-central-filter.component.html',
    styleUrls: ['./cdk-modalidade-orgao-central-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeOrgaoCentralFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-orgao-central-filter').close();
    }
