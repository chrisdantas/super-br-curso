...
@Component({
    selector: 'cdk-modalidade-vinculacao-documento-filter',
    templateUrl: './cdk-modalidade-vinculacao-documento-filter.component.html',
    styleUrls: ['./cdk-modalidade-vinculacao-documento-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeVinculacaoDocumentoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-vinculacao-documento-filter').close();
    }
