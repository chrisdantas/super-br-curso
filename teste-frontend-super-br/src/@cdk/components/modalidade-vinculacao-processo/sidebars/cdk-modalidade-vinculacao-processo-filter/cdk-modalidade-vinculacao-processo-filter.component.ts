...
@Component({
    selector: 'cdk-modalidade-vinculacao-processo-filter',
    templateUrl: './cdk-modalidade-vinculacao-processo-filter.component.html',
    styleUrls: ['./cdk-modalidade-vinculacao-processo-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeVinculacaoProcessoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-vinculacao-processo-filter').close();
    }
