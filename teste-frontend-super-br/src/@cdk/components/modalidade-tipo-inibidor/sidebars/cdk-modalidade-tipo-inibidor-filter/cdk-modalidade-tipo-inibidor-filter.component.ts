...
@Component({
    selector: 'cdk-modalidade-tipo-inibidor-filter',
    templateUrl: './cdk-modalidade-tipo-inibidor-filter.component.html',
    styleUrls: ['./cdk-modalidade-tipo-inibidor-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeTipoInibidorFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-tipo-inibidor-filter').close();
    }
