...
@Component({
    selector: 'cdk-modalidade-afastamento-filter',
    templateUrl: './cdk-modalidade-afastamento-filter.component.html',
    styleUrls: ['./cdk-modalidade-afastamento-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeAfastamentoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-afastamento-filter').close();
    }
