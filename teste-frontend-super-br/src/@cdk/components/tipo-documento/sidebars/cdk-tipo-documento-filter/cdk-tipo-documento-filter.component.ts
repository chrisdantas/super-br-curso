...
@Component({
    selector: 'cdk-tipo-documento-filter',
    templateUrl: './cdk-tipo-documento-filter.component.html',
    styleUrls: ['./cdk-tipo-documento-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkTipoDocumentoFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('especieDocumento').value) {
        ...
        this._cdkSidebarService.getSidebar('cdk-tipo-documento-filter').close();
    }
