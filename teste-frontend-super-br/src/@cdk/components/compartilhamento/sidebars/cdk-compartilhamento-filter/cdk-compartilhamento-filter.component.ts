...
@Component({
    selector: 'cdk-compartilhamento-filter',
    templateUrl: './cdk-compartilhamento-filter.component.html',
    styleUrls: ['./cdk-compartilhamento-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkCompartilhamentoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-compartilhamento-filter').close();
    }
