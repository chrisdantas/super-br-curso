...
import '@cdk/components/highlight/prism-languages';

@Component({
    selector : 'cdk-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class CdkHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using cdk-highlight
        // component
