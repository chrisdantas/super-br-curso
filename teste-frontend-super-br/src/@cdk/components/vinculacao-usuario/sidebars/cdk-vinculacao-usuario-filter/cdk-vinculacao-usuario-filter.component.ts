...
@Component({
    ...
    templateUrl: './cdk-vinculacao-usuario-filter.component.html',
    styleUrls: ['./cdk-vinculacao-usuario-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkVinculacaoUsuarioFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('usuarioVinculado').value) {
