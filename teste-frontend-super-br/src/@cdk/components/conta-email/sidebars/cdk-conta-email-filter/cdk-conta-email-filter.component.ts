...
@Component({
    selector: 'cdk-conta-email-filter',
    templateUrl: './cdk-conta-email-filter.component.html',
    styleUrls: ['./cdk-conta-email-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkContaEmailFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('servidorEmail').value) {
            andXFilter.push({'servidorEmail.id': `eq:${this.form.get('servidorEmail').value.id}`});
        }
        ...
        this._cdkSidebarService.getSidebar('cdk-conta-email-filter').close();
    }
