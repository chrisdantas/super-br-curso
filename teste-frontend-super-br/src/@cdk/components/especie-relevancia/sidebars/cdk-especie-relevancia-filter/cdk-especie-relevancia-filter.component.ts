...
@Component({
    selector: 'cdk-especie-relevancia-filter',
    templateUrl: './cdk-especie-relevancia-filter.component.html',
    styleUrls: ['./cdk-especie-relevancia-filter.component.scss'],
...
export class CdkEspecieRelevanciaFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('generoRelevancia').value) {
            andXFilter.push({'generoRelevancia.id': `eq:${this.form.get('generoRelevancia').value.id}`});
        }
