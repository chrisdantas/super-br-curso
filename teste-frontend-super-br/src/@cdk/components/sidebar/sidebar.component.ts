...
export class CdkSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._cdkConfigService.config
            ...
            .subscribe((config) => {
                this._cdkConfig = config;
            });

        // Register the sidebar
        this._cdkSidebarService.register(this.name, this);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('cdk-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('cdk-sidebar-overlay-invisible');
        }
