...
@Component({
    selector: 'cdk-modalidade-fase-filter',
    templateUrl: './cdk-modalidade-fase-filter.component.html',
    styleUrls: ['./cdk-modalidade-fase-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeFaseFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-fase-filter').close();
    }
