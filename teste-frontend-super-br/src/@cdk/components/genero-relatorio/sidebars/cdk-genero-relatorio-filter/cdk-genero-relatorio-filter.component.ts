...
@Component({
    selector: 'cdk-genero-relatorio-filter',
    templateUrl: './cdk-genero-relatorio-filter.component.html',
    styleUrls: ['./cdk-genero-relatorio-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkGeneroRelatorioFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-genero-relatorio-filter').close();
    }
