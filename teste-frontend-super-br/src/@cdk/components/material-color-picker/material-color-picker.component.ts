...
export const CDK_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => CdkMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'cdk-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : cdkAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [CDK_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class CdkMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, cdk-navy-700 etc.)
