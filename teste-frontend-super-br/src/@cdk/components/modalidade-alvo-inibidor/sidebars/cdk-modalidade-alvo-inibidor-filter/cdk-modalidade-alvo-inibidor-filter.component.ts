...
@Component({
    selector: 'cdk-modalidade-alvo-inibidor-filter',
    templateUrl: './cdk-modalidade-alvo-inibidor-filter.component.html',
    styleUrls: ['./cdk-modalidade-alvo-inibidor-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeAlvoInibidorFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-alvo-inibidor-filter').close();
