...
@Component({
    ...
    templateUrl: './cdk-aviso-autocomplete.component.html',
    styleUrls: ['./cdk-aviso-autocomplete.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations,
    exportAs: 'avisoAutocomplete',
})
export class CdkAvisoAutocompleteComponent implements OnInit {
            ...
            switchMap((value) => {
                    ...
                    if (typeof value === 'string' && andxFilter.length > 0) {
                        ...
                        return this._avisoService.query(
                            ...
                            .pipe(
                                finalize(() => this.avisoListIsLoading = false),
                                catchError(() => of([]))
                            );
                    } else {
                        return of([]);
