...
@Component({
    selector: 'cdk-especie-processo-filter',
    templateUrl: './cdk-especie-processo-filter.component.html',
    styleUrls: ['./cdk-especie-processo-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkEspecieProcessoFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('generoProcesso').value) {
            andXFilter.push({'generoProcesso.id': `eq:${this.form.get('generoProcesso').value.id}`});
        }
        ...
        this._cdkSidebarService.getSidebar('cdk-especie-processo-filter').close();
    }
