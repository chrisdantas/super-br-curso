...
@Component({
    selector: 'cdk-modalidade-repositorio-filter',
    templateUrl: './cdk-modalidade-repositorio-filter.component.html',
    styleUrls: ['./cdk-modalidade-repositorio-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeRepositorioFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-repositorio-filter').close();
    }
