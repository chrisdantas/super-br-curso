...
@Component({
    selector: 'cdk-modalidade-template-filter',
    templateUrl: './cdk-modalidade-template-filter.component.html',
    styleUrls: ['./cdk-modalidade-template-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeTemplateFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-template-filter').close();
    }
