...
@Component({
    selector: 'cdk-configuracao-nup-filter',
    templateUrl: './cdk-configuracao-nup-filter.component.html',
    styleUrls: ['./cdk-configuracao-nup-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkConfiguracaoNupFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-configuracao-nup-filter').close();
    }
