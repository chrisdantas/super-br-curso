...
@Component({
    selector: 'cdk-genero-tarefa-filter',
    templateUrl: './cdk-genero-tarefa-filter.component.html',
    styleUrls: ['./cdk-genero-tarefa-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkGeneroTarefaFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-genero-tarefa-filter').close();
    }
