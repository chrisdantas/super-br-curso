...
@Component({
    selector: 'cdk-modalidade-destinacao-filter',
    templateUrl: './cdk-modalidade-destinacao-filter.component.html',
    styleUrls: ['./cdk-modalidade-destinacao-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeDestinacaoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-destinacao-filter').close();
    }
