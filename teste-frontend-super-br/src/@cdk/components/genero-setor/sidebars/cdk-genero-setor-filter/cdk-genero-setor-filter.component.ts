...
@Component({
    selector: 'cdk-genero-setor-filter',
    templateUrl: './cdk-genero-setor-filter.component.html',
    styleUrls: ['./cdk-genero-setor-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkGeneroSetorFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-genero-setor-filter').close();
    }
