...
@Component({
    selector: 'cdk-tipo-validacao-criado-por',
    templateUrl: './cdk-tipo-validacao-criado-por.component.html',
    styleUrls: ['./cdk-tipo-validacao-criado-por.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkTipoValidacaoCriadoPorComponent implements OnInit, OnChanges, OnDestroy {
