...
@Component({
    selector: 'cdk-vinculacao-setor-municipio-filter',
    templateUrl: './cdk-vinculacao-setor-municipio-filter.component.html',
    styleUrls: ['./cdk-vinculacao-setor-municipio-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkVinculacaoSetorMunicipioFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-vinculacao-setor-municipio-filter').close();
    }
