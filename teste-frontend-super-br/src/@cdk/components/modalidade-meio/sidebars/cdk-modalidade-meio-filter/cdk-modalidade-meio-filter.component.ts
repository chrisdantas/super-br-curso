...
@Component({
    selector: 'cdk-modalidade-meio-filter',
    templateUrl: './cdk-modalidade-meio-filter.component.html',
    styleUrls: ['./cdk-modalidade-meio-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeMeioFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-meio-filter').close();
    }
