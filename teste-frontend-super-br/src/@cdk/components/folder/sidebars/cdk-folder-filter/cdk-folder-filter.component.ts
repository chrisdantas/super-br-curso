...
@Component({
    selector: 'cdk-folder-filter',
    templateUrl: './cdk-folder-filter.component.html',
    styleUrls: ['./cdk-folder-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkFolderFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('modalidadeFolder').value) {
            andXFilter.push({'modalidadeFolder.id': `eq:${this.form.get('modalidadeFolder').value.id}`});
        }
