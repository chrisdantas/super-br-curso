...
@Component({
    selector: 'cdk-relevancia-filter',
    templateUrl: './cdk-relevancia-filter.component.html',
    styleUrls: ['./cdk-relevancia-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkRelevanciaFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('especieRelevancia').value) {
            andXFilter.push({'especieRelevancia.id': `eq:${this.form.get('especieRelevancia').value.id}`});
        }
