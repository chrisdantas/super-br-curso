...
import {CdkTipoAcaoWorkflowTrigger004Component} from './cdk-tipo-acao-workflow-trigger-004.component';
...
@NgModule({
    declarations: [
        CdkTipoAcaoWorkflowTrigger004Component,
    ],
    imports: [
        MatAutocompleteModule,
        MatButtonModule,
...
export class CdkTipoAcaoWorkflowTrigger004Module {
}
