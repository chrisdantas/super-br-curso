...
@Component({
    selector: 'cdk-modalidade-modelo-filter',
    templateUrl: './cdk-modalidade-modelo-filter.component.html',
    styleUrls: ['./cdk-modalidade-modelo-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeModeloFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-modelo-filter').close();
    }
