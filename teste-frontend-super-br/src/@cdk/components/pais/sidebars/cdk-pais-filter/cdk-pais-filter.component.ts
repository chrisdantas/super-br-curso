...
@Component({
    selector: 'cdk-pais-filter',
    templateUrl: './cdk-pais-filter.component.html',
    styleUrls: ['./cdk-pais-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkPaisFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-pais-filter').close();
    }
