...
@Component({
    selector: 'cdk-tipo-contato-filter',
    templateUrl: './cdk-tipo-contato-filter.component.html',
    styleUrls: ['./cdk-tipo-contato-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkTipoContatoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-tipo-contato-filter').close();
    }
