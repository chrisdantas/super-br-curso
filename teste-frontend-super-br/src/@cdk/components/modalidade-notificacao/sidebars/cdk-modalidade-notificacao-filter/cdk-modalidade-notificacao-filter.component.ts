...
@Component({
    selector: 'cdk-modalidade-notificacao-filter',
    templateUrl: './cdk-modalidade-notificacao-filter.component.html',
    styleUrls: ['./cdk-modalidade-notificacao-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeNotificacaoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-notificacao-filter').close();
    }
