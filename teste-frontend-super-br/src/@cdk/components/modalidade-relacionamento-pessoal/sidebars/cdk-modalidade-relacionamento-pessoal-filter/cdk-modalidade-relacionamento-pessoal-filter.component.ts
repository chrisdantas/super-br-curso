...
@Component({
    selector: 'cdk-modalidade-relacionamento-pessoal-filter',
    templateUrl: './cdk-modalidade-relacionamento-pessoal-filter.component.html',
    styleUrls: ['./cdk-modalidade-relacionamento-pessoal-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeRelacionamentoPessoalFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-relacionamento-pessoal-filter').close();
    }
