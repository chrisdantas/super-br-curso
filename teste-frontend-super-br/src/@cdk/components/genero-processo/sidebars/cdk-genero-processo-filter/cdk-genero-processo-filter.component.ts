...
@Component({
    selector: 'cdk-genero-processo-filter',
    templateUrl: './cdk-genero-processo-filter.component.html',
    styleUrls: ['./cdk-genero-processo-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkGeneroProcessoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-genero-processo-filter').close();
    }
