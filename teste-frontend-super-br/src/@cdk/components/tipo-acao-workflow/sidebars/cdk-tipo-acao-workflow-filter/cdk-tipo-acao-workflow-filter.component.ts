...
@Component({
    selector: 'cdk-tipo-acao-workflow-filter',
    templateUrl: './cdk-tipo-acao-workflow-filter.component.html',
    styleUrls: ['./cdk-tipo-acao-workflow-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkTipoAcaoWorkflowFilterComponent {
