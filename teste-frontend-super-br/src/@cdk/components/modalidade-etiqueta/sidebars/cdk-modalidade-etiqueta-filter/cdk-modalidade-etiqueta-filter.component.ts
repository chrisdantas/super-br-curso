...
@Component({
    selector: 'cdk-modalidade-etiqueta-filter',
    templateUrl: './cdk-modalidade-etiqueta-filter.component.html',
    styleUrls: ['./cdk-modalidade-etiqueta-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeEtiquetaFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-etiqueta-filter').close();
    }
