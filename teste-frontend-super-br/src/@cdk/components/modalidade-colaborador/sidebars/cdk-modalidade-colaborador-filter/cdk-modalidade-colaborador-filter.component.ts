...
@Component({
    selector: 'cdk-modalidade-colaborador-filter',
    templateUrl: './cdk-modalidade-colaborador-filter.component.html',
    styleUrls: ['./cdk-modalidade-colaborador-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeColaboradorFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-colaborador-filter').close();
    }
