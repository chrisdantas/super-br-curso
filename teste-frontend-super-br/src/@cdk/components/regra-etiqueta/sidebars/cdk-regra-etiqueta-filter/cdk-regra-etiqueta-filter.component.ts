...
@Component({
    selector: 'cdk-regra-etiqueta-filter',
    templateUrl: './cdk-regra-etiqueta-filter.component.html',
    styleUrls: ['./cdk-regra-etiqueta-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkRegraEtiquetaFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-regra-etiqueta-filter').close();
    }
