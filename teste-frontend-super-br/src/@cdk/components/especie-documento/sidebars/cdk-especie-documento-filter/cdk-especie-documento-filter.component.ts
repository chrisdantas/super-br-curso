...
@Component({
    selector: 'cdk-especie-documento-filter',
    templateUrl: './cdk-especie-documento-filter.component.html',
    styleUrls: ['./cdk-especie-documento-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkEspecieDocumentoFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('generoDocumento').value) {
            andXFilter.push({'generoDocumento.id': `eq:${this.form.get('generoDocumento').value.id}`});
        }
        ...
        this._cdkSidebarService.getSidebar('cdk-especie-documento-filter').close();
    }
