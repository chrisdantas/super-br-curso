...
@Component({
    selector: 'cdk-genero-relevancia-filter',
    templateUrl: './cdk-genero-relevancia-filter.component.html',
    styleUrls: ['./cdk-genero-relevancia-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkGeneroRelevanciaFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-genero-relevancia-filter').close();
    }
