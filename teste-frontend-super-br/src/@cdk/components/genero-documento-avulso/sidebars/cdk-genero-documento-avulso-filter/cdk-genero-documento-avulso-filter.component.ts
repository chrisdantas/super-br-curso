...
@Component({
    selector: 'cdk-genero-documento-avulso-filter',
    templateUrl: './cdk-genero-documento-avulso-filter.component.html',
    styleUrls: ['./cdk-genero-documento-avulso-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkGeneroDocumentoAvulsoFilterComponent {
