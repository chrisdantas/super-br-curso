...
@Component({
    selector: 'cdk-modalidade-folder-filter',
    templateUrl: './cdk-modalidade-folder-filter.component.html',
    styleUrls: ['./cdk-modalidade-folder-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeFolderFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-folder-filter').close();
    }
