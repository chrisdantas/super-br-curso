...
@Component({
    selector: 'cdk-modalidade-transicao-filter',
    templateUrl: './cdk-modalidade-transicao-filter.component.html',
    styleUrls: ['./cdk-modalidade-transicao-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeTransicaoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-transicao-filter').close();
    }
