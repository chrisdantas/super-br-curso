...
@Component({
    selector: 'cdk-modalidade-copia-filter',
    templateUrl: './cdk-modalidade-copia-filter.component.html',
    styleUrls: ['./cdk-modalidade-copia-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeCopiaFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-copia-filter').close();
    }
