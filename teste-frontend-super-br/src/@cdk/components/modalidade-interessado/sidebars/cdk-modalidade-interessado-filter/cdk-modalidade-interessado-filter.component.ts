...
@Component({
    selector: 'cdk-modalidade-interessado-filter',
    templateUrl: './cdk-modalidade-interessado-filter.component.html',
    styleUrls: ['./cdk-modalidade-interessado-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeInteressadoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-interessado-filter').close();
    }
