...
@Component({
    selector: 'cdk-modalidade-documento-identificador-filter',
    templateUrl: './cdk-modalidade-documento-identificador-filter.component.html',
    styleUrls: ['./cdk-modalidade-documento-identificador-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeDocumentoIdentificadorFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-documento-identificador-filter').close();
    }
