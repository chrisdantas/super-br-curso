...
@Component({
    ...
    styleUrls: ['./cdk-especie-atividade-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkEspecieAtividadeFilterComponent {
    ...
    emite(): void {
        ...
        if (this.form.get('generoAtividade').value) {
            andXFilter.push({'generoAtividade.id': `eq:${this.form.get('generoAtividade').value.id}`});
        }
