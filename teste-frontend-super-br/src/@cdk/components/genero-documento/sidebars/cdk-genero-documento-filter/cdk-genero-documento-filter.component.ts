...
@Component({
    selector: 'cdk-genero-documento-filter',
    templateUrl: './cdk-genero-documento-filter.component.html',
    styleUrls: ['./cdk-genero-documento-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkGeneroDocumentoFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-genero-documento-filter').close();
    }
