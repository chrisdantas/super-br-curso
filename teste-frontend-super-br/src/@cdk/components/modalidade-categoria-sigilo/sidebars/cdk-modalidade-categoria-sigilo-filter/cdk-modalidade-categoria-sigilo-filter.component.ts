...
@Component({
    selector: 'cdk-modalidade-categoria-sigilo-filter',
    templateUrl: './cdk-modalidade-categoria-sigilo-filter.component.html',
    styleUrls: ['./cdk-modalidade-categoria-sigilo-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class CdkModalidadeCategoriaSigiloFilterComponent {
    ...
    emite(): void {
        ...
        this._cdkSidebarService.getSidebar('cdk-modalidade-categoria-sigilo-filter').close();
    }
