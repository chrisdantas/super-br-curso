...
export const normalize = (schema, input, parent, key, visit, addEntity, visitedEntities, populate) => {
  ...
  return values.map((value, index) => visit(value, parent, key, schema, addEntity, visitedEntities, populate));
};
