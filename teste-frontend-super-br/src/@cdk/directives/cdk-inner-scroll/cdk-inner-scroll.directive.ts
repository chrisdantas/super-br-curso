...
export class CdkInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
    ...
    constructor(
        ...
        private _cdkMediaMatchService: CdkMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._cdkMediaMatchService.onMediaChange
