...
export class CdkPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set cdkPerfectScrollbarOptions(value)
    {
        // Merge the options
    ...
    get cdkPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.cdkPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.cdkPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): CdkPerfectScrollbarGeometry
    {
        return new CdkPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): CdkPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new CdkPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
