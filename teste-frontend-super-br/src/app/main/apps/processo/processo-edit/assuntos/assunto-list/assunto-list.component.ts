...
export class AssuntoListComponent implements OnInit, OnDestroy {
    ...
    edit(assuntoId: number): void {
        this._router.navigate([this.routerState.url.replace('listar', 'editar/') + assuntoId]).then();
    }

    delete(assuntoId: number, loteId: string = null): void {
