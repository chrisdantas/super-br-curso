...
export const GET_VISIBILIDADES = '[VISIBILIDADE LIST] GET VISIBILIDADES';
export const GET_VISIBILIDADES_SUCCESS = '[VISIBILIDADE LIST] GET VISIBILIDADES SUCCESS';
export const GET_VISIBILIDADES_FAILED = '[VISIBILIDADE LIST] GET VISIBILIDADES FAILED';

export const RELOAD_VISIBILIDADES = '[VISIBILIDADE LIST] RELOAD VISIBILIDADES';

export const DELETE_VISIBILIDADE = '[VISIBILIDADE LIST] DELETE VISIBILIDADE';
export const DELETE_VISIBILIDADE_SUCCESS = '[VISIBILIDADE LIST] DELETE VISIBILIDADE SUCCESS';
export const DELETE_VISIBILIDADE_FAILED = '[VISIBILIDADE LIST] DELETE VISIBILIDADE FAILED';
