...
export class VolumeListComponent implements OnInit, OnDestroy {
    ...
    edit(volumeId: number): void {
        this._router.navigate([this.routerState.url.replace('listar', 'editar/') + volumeId]).then();
    }

    delete(volumeId: number, loteId: string = null): void {
        const operacaoId = CdkUtils.makeId();
        this._store.dispatch(new fromStore.DeleteVolume({
            volumeId: volumeId,
