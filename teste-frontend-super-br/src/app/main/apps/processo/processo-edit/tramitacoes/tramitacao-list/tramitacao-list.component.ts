...
export class TramitacaoListComponent implements OnInit, OnDestroy {
    ...
    view(tramitacaoId: number): void {
        this._router.navigate([this.routerState.url.replace('listar', 'visualizar/') + tramitacaoId]).then();
    }
}
