...
export const GET_MODALIDADE_TRANSICAO = '[ARQUIVISTA-LIST] GET MODALIDADE TRANSICAO';
export const GET_MODALIDADE_TRANSICAO_SUCCESS = '[ARQUIVISTA-LIST] GET MODALIDADE TRANSICAO SUCCESS';
export const GET_MODALIDADE_TRANSICAO_FAILED = '[ARQUIVISTA-LIST] GET MODALIDADE TRANSICAO FAILED';

export const UNLOAD_MODALIDADE_TRANSICAO = '[ARQUIVISTA-LIST] UNLOAD MODALIDADE TRANSICAO';
