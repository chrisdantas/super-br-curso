...
import {RegistrarExtravioComponent} from './registrar-extravio.component';
...
const routes: Routes = [
    {
        path: '',
        component: RegistrarExtravioComponent,
        canActivate: [fromGuards.ResolveGuard]
    }
];
@NgModule({
    declarations: [RegistrarExtravioComponent],
    imports: [
...
export class RegistrarExtravioModule {
}
