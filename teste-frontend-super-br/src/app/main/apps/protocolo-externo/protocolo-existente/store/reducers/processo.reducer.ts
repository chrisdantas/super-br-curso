...
export function ProcessoReducer(state = ProcessoInitialState, action: ProcessoActions.ProcessoActionsAll): ProcessoState {
    switch (action.type) {
        ...
        case ProcessoActions.GET_PROCESSO_EXISTENTE: {
            return {
                processoId: null,
                loaded: false,
                loading: true,
        ...
        case ProcessoActions.GET_PROCESSO_EXISTENTE_SUCCESS: {
        ...
        case ProcessoActions.GET_PROCESSO_EXISTENTE_FAILED: {
            return {
                processoId: null,
                loading: false,
                loaded: false,
        ...
        case ProcessoActions.UNLOAD_PROCESSO_EXISTENTE: {
            return {
