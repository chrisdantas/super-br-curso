...
export const ENVIAR_DOCUMENTO = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ENVIAR RESPOSTA';
export const ENVIAR_DOCUMENTO_SUCCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ENVIAR RESPOSTA SUCCESS';
export const ENVIAR_DOCUMENTO_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ENVIAR RESPOSTA FAILED';

export const GET_DOCUMENTOS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] GET DOCUMENTOS';
export const GET_DOCUMENTOS_SUCCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] GET DOCUMENTOS SUCCESS';
export const GET_DOCUMENTOS_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] GET DOCUMENTOS FAILED';

export const UNLOAD_DOCUMENTOS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] UNLOAD DOCUMENTOS';
export const CLICKED_DOCUMENTO = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CLICKED DOCUMENTO';

export const ASSINA_DOCUMENTO = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ASSINA DOCUMENTO';
export const ASSINA_DOCUMENTO_SUCCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ASSINA DOCUMENTO SUCCESS';
export const ASSINA_DOCUMENTO_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ASSINA DOCUMENTO FAILED';

export const ASSINA_DOCUMENTO_ELETRONICAMENTE = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ASSINA DOCUMENTO ELETRONICAMENTE';
export const ASSINA_DOCUMENTO_ELETRONICAMENTE_SUCCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ASSINA DOCUMENTO ELETRONICAMENTE SUCCESS';
export const ASSINA_DOCUMENTO_ELETRONICAMENTE_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] ASSINA DOCUMENTO ELETRONICAMENTE FAILED';

export const REMOVE_ASSINATURA_DOCUMENTO = '[PROTOCOLO-EXISTENTE-DOCUMENTO] REMOVE ASSINATURA DOCUMENTO';
export const REMOVE_ASSINATURA_DOCUMENTO_SUCCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] REMOVE ASSINATURA DOCUMENTO SUCCESS';
export const REMOVE_ASSINATURA_DOCUMENTO_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] REMOVE ASSINATURA DOCUMENTO FAILED';

export const CONVERTE_DOCUMENTO_ATIVIDADE = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CONVERTE DOCUMENTO ATIVIDADE';
export const CONVERTE_DOCUMENTO_SUCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CONVERTE DOCUMENTO ATIVIDADE SUCCESS';
export const CONVERTE_DOCUMENTO_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CONVERTE DOCUMENTO ATIVIDADE FAILED';

export const CONVERTE_DOCUMENTO_ATIVIDADE_HTML = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CONVERTE DOCUMENTO ATIVIDADE HTML';
export const CONVERTE_DOCUMENTO_HTML_SUCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CONVERTE DOCUMENTO ATIVIDADE HTML SUCCESS';
export const CONVERTE_DOCUMENTO_HTML_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CONVERTE DOCUMENTO ATIVIDADE HTML FAILED';

export const DOWNLOAD_DOCUMENTO_P7S = '[PROTOCOLO-EXISTENTE-DOCUMENTO] DOWNLOAD DOCUMENTO P7S';
export const DOWNLOAD_DOCUMENTO_SUCCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] DOWNLOAD DOCUMENTO P7S SUCESS';
export const DOWNLOAD_DOCUMENTO_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] DOWNLOAD DOCUMENTO P7S FAILED';

export const CHANGE_SELECTED_DOCUMENTOS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] CHANGE SELECTED DOCUMENTOS';

export const UPDATE_DOCUMENTO = '[PROTOCOLO-EXISTENTE-DOCUMENTO] UPDATE DOCUMENTO';
export const UPDATE_DOCUMENTO_SUCCESS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] UPDATE DOCUMENTO SUCCESS';
export const UPDATE_DOCUMENTO_FAILED = '[PROTOCOLO-EXISTENTE-DOCUMENTO] UPDATE DOCUMENTO FAILED';

export const SET_SAVING = '[PROTOCOLO-EXISTENTE-DOCUMENTO] SET SAVING COMPONENTES DIGITAIS';

export const RELOAD_DOCUMENTOS = '[PROTOCOLO-EXISTENTE-DOCUMENTO] RELOAD DOCUMENTOS';
