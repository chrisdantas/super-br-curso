...
@Component({
    selector: 'vinculacoes-usuarios',
    templateUrl: './vinculacoes-usuarios.component.html',
    styleUrls: ['./vinculacoes-usuarios.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class VinculacoesUsuariosComponent implements OnInit, OnDestroy {
