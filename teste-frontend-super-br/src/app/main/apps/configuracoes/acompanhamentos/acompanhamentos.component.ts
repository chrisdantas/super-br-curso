...
export class AcompanhamentosComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this._store.pipe(
            ...
            if (this.routerState.url.indexOf('acompanhamentos/editar') > -1) {
                this.action = 'editar';
            }
            if (this.routerState.url.indexOf('acompanhamentos/criar') > -1) {
                this.action = 'criar';
            }
