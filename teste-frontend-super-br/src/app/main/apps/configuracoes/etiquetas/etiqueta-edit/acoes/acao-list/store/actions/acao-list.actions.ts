...
export const GET_ACOES = '[ACAO LIST] GET ACOES';
export const GET_ACOES_SUCCESS = '[ACAO LIST] GET ACOES SUCCESS';
export const GET_ACOES_FAILED = '[ACAO LIST] GET ACOES FAILED';

export const RELOAD_ACOES = '[ACAO LIST] RELOAD ACOES';

export const DELETE_ACAO = '[ACAO LIST] DELETE ACAO';
export const DELETE_ACAO_SUCCESS = '[ACAO LIST] DELETE ACAO SUCCESS';
export const DELETE_ACAO_FAILED = '[ACAO LIST] DELETE ACAO FAILED';
