...
export const GET_COORDENADORES = '[COORDENADOR COORDENADORES LIST] GET COORDENADORES';
export const GET_COORDENADORES_SUCCESS = '[COORDENADOR COORDENADORES LIST] GET COORDENADORES SUCCESS';
export const GET_COORDENADORES_FAILED = '[COORDENADOR COORDENADORES LIST] GET COORDENADORES FAILED';

export const RELOAD_COORDENADORES = '[COORDENADOR COORDENADORES LIST] RELOAD COORDENADORES';

export const DELETE_COORDENADOR = '[COORDENADOR COORDENADORES LIST] DELETE COORDENADOR';
export const DELETE_COORDENADOR_SUCCESS = '[COORDENADOR COORDENADORES LIST] DELETE COORDENADOR SUCCESS';
export const DELETE_COORDENADOR_FAILED = '[COORDENADOR COORDENADORES LIST] DELETE COORDENADOR FAILED';
