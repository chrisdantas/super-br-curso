...
export const CREATE_SETOR = '[COORDENADOR SETOR EDIT] CREATE SETOR';
export const CREATE_SETOR_SUCCESS = '[COORDENADOR SETOR EDIT] CREATE SETOR SUCCESS';

export const SAVE_SETOR = '[COORDENADOR SETOR EDIT] SAVE SETOR';
export const SAVE_SETOR_SUCCESS = '[COORDENADOR SETOR EDIT] SAVE SETOR SUCCESS';
export const SAVE_SETOR_FAILED = '[COORDENADOR SETOR EDIT] SAVE SETOR FAILED';

export const GET_SETOR = '[COORDENADOR SETOR EDIT] GET SETOR';
export const GET_SETOR_SUCCESS = '[COORDENADOR SETOR EDIT] GET SETOR SUCCESS';
export const GET_SETOR_FAILED = '[COORDENADOR SETOR EDIT] GET SETOR FAILED';
