...
import * as RepositorioListActions from '../../../repositorios-list/store/actions/repositorios-list.actions';
...
export class RepositorioEditEffect {
     ...
     * @type {Observable<any>}
     */
    getRepositorio: Observable<any> = createEffect(() => this._actions.pipe(
