...
export const GET_MODELOS = '[DOCUMENTO EDIT] GET MODELOS';
export const GET_MODELOS_SUCCESS = '[DOCUMENTO EDIT] GET MODELOS SUCCESS';
export const GET_MODELOS_FAILED = '[DOCUMENTO EDIT] GET MODELOS FAILED';

export const UNLOAD_MODELOS = '[DOCUMENTO EDIT] UNLOAD MODELOS';
