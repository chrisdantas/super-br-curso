...
export const CREATE_COMPONENTE_DIGITAL = '[DOCUMENTO EDIT MODELO] CREATE COMPONENTE DIGITAL';
export const CREATE_COMPONENTE_DIGITAL_SUCCESS = '[DOCUMENTO EDIT MODELO] CREATE COMPONENTE DIGITAL SUCCESS';

export const SAVE_COMPONENTE_DIGITAL = '[DOCUMENTO EDIT MODELO] SAVE COMPONENTE DIGITAL';
export const SAVE_COMPONENTE_DIGITAL_SUCCESS = '[DOCUMENTO EDIT MODELO] SAVE COMPONENTE DIGITAL SUCCESS';
export const SAVE_COMPONENTE_DIGITAL_FAILED = '[DOCUMENTO EDIT MODELO] SAVE COMPONENTE DIGITAL FAILED';

export const GET_DOCUMENTO = '[DOCUMENTO EDIT MODELO] GET DOCUMENTO';
export const GET_DOCUMENTO_SUCCESS = '[DOCUMENTO EDIT MODELO] GET DOCUMENTO SUCCESS';
export const GET_DOCUMENTO_FAILED = '[DOCUMENTO EDIT MODELO] GET DOCUMENTO FAILED';
