...
export const UPDATE_DOCUMENTO_VINCULADO = '[DOCUMENTO EDIT] UPDATE DOCUMENTO VINCULADO';
export const UPDATE_DOCUMENTO_VINCULADO_SUCCESS = '[DOCUMENTO EDIT] UPDATE DOCUMENTO VINCULADO SUCCESS';
export const UPDATE_DOCUMENTO_VINCULADO_FAILED = '[DOCUMENTO EDIT] UPDATE DOCUMENTO VINCULADO FAILED';

export const DOWNLOAD_DOCUMENTO_VINCULADO_P7S = '[DOCUMENTO EDIT] DOWNLOAD P7S DOCUMENTO VINCULADO';
export const DOWNLOAD_DOCUMENTO_VINCULADO_P7S_SUCCESS = '[DOCUMENTO EDIT] DOWNLOAD P7S DOCUMENTO VINCULADO SUCCESS';
export const DOWNLOAD_DOCUMENTO_VINCULADO_P7S_FAILED = '[DOCUMENTO EDIT] DOWNLOAD P7S DOCUMENTO VINCULADO FAILED';
