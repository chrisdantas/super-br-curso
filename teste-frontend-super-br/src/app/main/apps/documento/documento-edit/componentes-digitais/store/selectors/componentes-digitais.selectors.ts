...
import {
    ...
    DocumentoEditComponentesDigitaisAppState,
...
export const getIsSavingComponenteDigital: any = createSelector(
    getComponenteDigitalState,
    (state: ComponenteDigitalState) => state.saving
);

export const getErrorsComponenteDigital: any = createSelector(
    getComponenteDigitalState,
    (state: ComponenteDigitalState) => state.errors
);
