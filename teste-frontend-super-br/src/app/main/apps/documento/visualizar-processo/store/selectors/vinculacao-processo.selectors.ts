...
import {getVisualizarProcessoAppState, VisualizarProcessoAppState, VinculacaoProcessoState} from '../reducers';
...
export const getVinculacaoProcessoState: any = createSelector(
    ...
    (state: VisualizarProcessoAppState) => state.vinculacoesProcessos
);
