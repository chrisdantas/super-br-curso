...
import {ComponenteDigitalState, DocumentoAvulsoEditDadosBasicosAppState, getDocumentoAvulsoEditDadosBasicosAppState} from '../reducers';
...
export const getComponenteDigitalState: any = createSelector(
    ...
    (state: DocumentoAvulsoEditDadosBasicosAppState) => state.componentesDigitais
);
