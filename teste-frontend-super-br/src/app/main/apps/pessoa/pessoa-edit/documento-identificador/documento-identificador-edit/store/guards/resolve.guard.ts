...
import {DocumentoIdentificadorEditAppState} from '../reducers';
...
export class ResolveGuard implements CanActivate {
     ...
     */
    constructor(
        private _store: Store<DocumentoIdentificadorEditAppState>
    ) {
        this._store.pipe(
        ...
        return this._store.pipe(
            ...
            tap((loaded: any) => {
                if (!this.routerState.params[loaded.id] || this.routerState.params[loaded.id] !== loaded.value) {
                    if (this.routerState.params['documentoIdentificadorHandle'] === 'criar') {
