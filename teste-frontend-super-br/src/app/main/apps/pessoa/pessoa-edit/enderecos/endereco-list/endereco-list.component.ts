...
export class EnderecoListComponent implements OnInit, OnDestroy {
    ...
    create(): void {
        this._router.navigate([this.routerState.url.replace('enderecos/listar', 'enderecos/editar/criar')]).then();
    }

    edit(enderecoId: number): void {
        this._router.navigate([this.routerState.url.replace('enderecos/listar', 'enderecos/editar/') + enderecoId]).then();
    }
