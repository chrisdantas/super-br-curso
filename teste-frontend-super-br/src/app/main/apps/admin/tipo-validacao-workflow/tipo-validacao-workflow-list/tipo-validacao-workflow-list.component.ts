...
export class TipoValidacaoWorkflowListComponent implements OnInit, OnDestroy {
    ...
    edit(tipoValidacaoWorkflowId: number): void {
        this._router.navigate([this.routerState.url.replace('listar', 'editar/') + tipoValidacaoWorkflowId]).then();
    }
    ...
    delete(tipoValidacaoWorkflowId: number, loteId: string = null): void {
        const operacaoId = CdkUtils.makeId();
        this._store.dispatch(new fromStore.DeleteTipoValidacaoWorkflow({
            tipoValidacaoWorkflowId: tipoValidacaoWorkflowId,
