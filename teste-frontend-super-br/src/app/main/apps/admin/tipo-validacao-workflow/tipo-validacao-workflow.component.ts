...
@Component({
    selector: 'tipo-validacao-workflow',
    templateUrl: './tipo-validacao-workflow.component.html',
    styleUrls: ['./tipo-validacao-workflow.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class TipoValidacaoWorkflowComponent implements OnInit, OnDestroy {
