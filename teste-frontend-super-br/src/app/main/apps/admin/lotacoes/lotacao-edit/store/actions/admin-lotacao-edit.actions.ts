...
export const CREATE_LOTACAO = '[ADMIN LOTACAO EDIT] CREATE LOTACAO';
export const CREATE_LOTACAO_SUCCESS = '[ADMIN LOTACAO EDIT] CREATE LOTACAO SUCCESS';

export const SAVE_LOTACAO = '[ADMIN LOTACAO EDIT] SAVE LOTACAO';
export const SAVE_LOTACAO_SUCCESS = '[ADMIN LOTACAO EDIT] SAVE LOTACAO SUCCESS';
export const SAVE_LOTACAO_FAILED = '[ADMIN LOTACAO EDIT] SAVE LOTACAO FAILED';

export const GET_LOTACAO = '[ADMIN LOTACAO EDIT] GET LOTACAO';
export const GET_LOTACAO_SUCCESS = '[ADMIN LOTACAO EDIT] GET LOTACAO SUCCESS';
export const GET_LOTACAO_FAILED = '[ADMIN LOTACAO EDIT] GET LOTACAO FAILED';
...
export type RootLotacaoEditActionsAll
    = CreateLotacao
