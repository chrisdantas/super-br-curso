...
@Component({
    ...
    templateUrl: './tipo-validacao-workflow-form-atr-para.component.html',
    styleUrls: ['./tipo-validacao-workflow-form-atr-para.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class TipoValidacaoWorkflowFormAtrParaComponent implements OnInit, OnDestroy {
    ...
    submit(values): void {
        values.contexto = JSON.stringify({atribuidoParaId: values.atribuidoPara.id});
