...
@Component({
    ...
    templateUrl: './tipo-validacao-workflow-form-unidade.component.html',
    styleUrls: ['./tipo-validacao-workflow-form-unidade.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class TipoValidacaoWorkflowFormUnidadeComponent implements OnInit, OnDestroy {
    ...
    submit(values): void {
        values.contexto = JSON.stringify({unidadeId: values.unidade.id});
