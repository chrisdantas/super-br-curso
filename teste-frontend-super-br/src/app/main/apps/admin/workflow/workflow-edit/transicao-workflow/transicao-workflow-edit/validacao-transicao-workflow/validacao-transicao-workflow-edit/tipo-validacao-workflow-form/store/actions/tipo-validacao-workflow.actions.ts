...
export const GET_TIPO_VALIDACAO_WORKFLOW = '[TIPO VALIDACAO WORKFLOW] GET TIPO VALIDACAO WORKFLOW';
export const GET_TIPO_VALIDACAO_WORKFLOW_SUCCESS = '[TIPO VALIDACAO WORKFLOW] GET TIPO VALIDACAO WORKFLOW SUCCESS';
export const GET_TIPO_VALIDACAO_WORKFLOW_FAILED = '[TIPO VALIDACAO WORKFLOW] GET TIPO VALIDACAO WORKFLOW FAILED';
...
export type GetTipoWorkflowActionsAll
