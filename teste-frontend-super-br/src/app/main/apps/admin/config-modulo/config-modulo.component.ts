...
@Component({
    selector: 'config-modulo',
    templateUrl: './config-modulo.component.html',
    styleUrls: ['./config-modulo.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class ConfigModuloComponent implements OnInit, OnDestroy {
