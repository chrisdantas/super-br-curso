...
import {ConfigModuloEditComponent} from './config-modulo-edit.component';
...
const routes: Routes = [
    {
        ...
        component: ConfigModuloEditComponent,
        canActivate: [fromGuards.ResolveGuard],
        data: {
            breadcrumb: {
                label: 'config-modulo {{configModuleHandle}}',
                url: '',
                module: 'admin'
            }
        }
...
@NgModule({
    declarations: [ConfigModuloEditComponent],
    imports: [
        CommonModule,
...
export class ConfigModuloEditModule {
}
