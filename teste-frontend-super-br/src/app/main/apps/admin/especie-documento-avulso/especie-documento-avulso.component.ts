...
@Component({
    selector: 'especie-documento-avulso',
    templateUrl: './especie-documento-avulso.component.html',
    styleUrls: ['./especie-documento-avulso.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class EspecieDocumentoAvulsoComponent implements OnInit, OnDestroy {
