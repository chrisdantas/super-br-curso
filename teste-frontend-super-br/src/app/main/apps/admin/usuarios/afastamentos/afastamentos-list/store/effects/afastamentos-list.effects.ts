...
export class AfastamentosListEffects {
     ...
     * @type {Observable<any>}
     */
    getAfastamentos: any = createEffect(() => this._actions.pipe(
     ...
     * @type {Observable<any>}
     */
    deleteAfastamento: Observable<AfastamentosListActions.AfastamentosListActionsAll> = createEffect(() => this._actions.pipe(
