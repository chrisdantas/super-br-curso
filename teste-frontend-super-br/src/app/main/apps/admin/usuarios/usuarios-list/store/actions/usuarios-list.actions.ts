...
export const RESET_SENHA = '[ADMIN USUARIO LIST] RESET SENHA';
export const RESET_SENHA_SUCCESS = '[ADMIN USUARIO LIST] RESET SENHA SUCCESS';
export const RESET_SENHA_FAILED = '[ADMIN USUARIO LIST] RESET SENHA FAILED';
