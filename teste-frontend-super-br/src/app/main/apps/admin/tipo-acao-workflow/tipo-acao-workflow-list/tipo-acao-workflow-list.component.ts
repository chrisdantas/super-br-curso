...
export class TipoAcaoWorkflowListComponent implements OnInit, OnDestroy {
    ...
    edit(tipoAcaoWorkflowId: number): void {
        this._router.navigate([this.routerState.url.replace('listar', 'editar/') + tipoAcaoWorkflowId]).then();
    }
