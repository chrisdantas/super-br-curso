...
@Component({
    selector: 'admin-pessoa',
    templateUrl: './admin-pessoa.component.html',
    styleUrls: ['./admin-pessoa.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    animations: cdkAnimations
})
export class AdminPessoaComponent implements OnInit, OnDestroy {
