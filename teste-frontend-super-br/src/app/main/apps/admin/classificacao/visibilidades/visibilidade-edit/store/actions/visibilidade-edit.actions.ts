...
export const CREATE_VISIBILIDADE = '[CLASSIFICACAO VISIBILIDADE] CREATE VISIBILIDADE';
export const CREATE_VISIBILIDADE_SUCCESS = '[CLASSIFICACAO VISIBILIDADE] CREATE VISIBILIDADE SUCCESS';

export const SAVE_VISIBILIDADE = '[CLASSIFICACAO VISIBILIDADE] SAVE VISIBILIDADE';
export const SAVE_VISIBILIDADE_SUCCESS = '[CLASSIFICACAO VISIBILIDADE] SAVE VISIBILIDADE SUCCESS';
export const SAVE_VISIBILIDADE_FAILED = '[CLASSIFICACAO VISIBILIDADE] SAVE VISIBILIDADE FAILED';

export const GET_VISIBILIDADE = '[CLASSIFICACAO VISIBILIDADE] GET VISIBILIDADE';
export const GET_VISIBILIDADE_SUCCESS = '[CLASSIFICACAO VISIBILIDADE] GET VISIBILIDADE SUCCESS';
export const GET_VISIBILIDADE_FAILED = '[CLASSIFICACAO VISIBILIDADE] GET VISIBILIDADE FAILED';

export const UNLOAD_STORE = '[CLASSIFICACAO VISIBILIDADE-EDIT] UNLOAD STORE';
