...
describe('Teste de criação de um processo simples com vinculação do tipo remissão', function () {

  beforeEach(function () {
    cy.fixture('processos/processo-simples-vinculacao-remissao.json').then((fixture) => {
  ...
  it('Deve permitir criar um processo simples com vinculação do tipo remissão (sem documentos) e distribuí-lo', function () {
