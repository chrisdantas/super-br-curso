...
describe('Teste de criação de um processo documento avulso com vinculação do tipo apensamento', function () {

  beforeEach(function () {
    cy.fixture('processos/processo-documento-avulso-vinculacao-apensamento.json').then((fixture) => {
  ...
  it('Deve permitir criar um processo documento avulso com vinculação do tipo apensamento (sem documentos) e distribuí-lo', function () {
