...
describe('Teste de criação de um processo simples existente', function () {

    beforeEach(function () {
      cy.fixture('processos/processo-simples-existente.json').then((fixture) => {
  ...
  it('Deve permitir criar um processo simples existente (sem documentos) e distribuí-lo', function () {
