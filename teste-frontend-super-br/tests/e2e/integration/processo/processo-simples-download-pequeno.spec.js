...
describe('Teste de criação de processo simples contendo um documento juntado', function () {
  
    const protocolo = new Protocolo()

    before(function () {
      cy.fixture('processos/processo-simples-download-pequeno.json').then((fixture) => {
  ...
  it('Deve permitir criar um processo simples com juntanda de um documento e distribuí-lo', function () {   
