...
describe('Teste de criação de um processo simples com vinculação do tipo apensamento', function () {

  beforeEach(function () {
    cy.fixture('processos/processo-simples-vinculacao-apensamento.json').then((fixture) => {
  ...
  it('Deve permitir criar um processo simples com vinculação do tipo apensamento (sem documentos) e distribuí-lo', function () {
