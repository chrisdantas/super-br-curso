...
describe('Teste de criação de um processo documento avulso com vinculação do tipo anexação', function () {

  beforeEach(function () {
    cy.fixture('processos/processo-documento-avulso-vinculacao-anexacao.json').then((fixture) => {
  ...
  it('Deve permitir criar um processo documento avulso com vinculação do tipo anexação (sem documentos) e distribuí-lo', function () {
