...
describe('Teste de criação de um processo documento avulso existente', function () {

  beforeEach(function () {
    cy.fixture('processos/processo-documento-avulso-existente.json').then((fixture) => {
        this.processo = fixture.processo;
        this.distribuicao = fixture.distribuicao;
    })
  })

  it('Deve permitir criar um processo documento avulso existente (sem documentos) e distribuí-lo', function () {
    ...
    protocolo.getDataHoraDeAbertura().dblclick().type(this.processo.dataHoraDeAbertura)
