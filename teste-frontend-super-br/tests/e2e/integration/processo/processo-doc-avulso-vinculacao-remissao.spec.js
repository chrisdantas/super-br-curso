...
describe('Teste de criação de um processo documento avulso com vinculação do tipo remissão', function () {

  beforeEach(function () {
    cy.fixture('processos/processo-documento-avulso-vinculacao-remissao.json').then((fixture) => {
  ...
  it('Deve permitir criar um processo documento avulso com vinculação do tipo remissão (sem documentos) e distribuí-lo', function () {
