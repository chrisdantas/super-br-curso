...
describe('Teste para cadastrar, editar e exluir espécies de relevâncias', function () {

    let paramNome

  beforeEach(function () {
    cy.fixture('admin/admin-especie-relevancias.json').then((fixture) => {
        this.admin = fixture.admin;
    })
  })

  it('Deve permitir cadastrar, editar e exluir espécies de relevâncias', function () {

    //locar no sistema
    cy.login('00000000004') 
    cy.visit("./apps/admin/especie-relevancias/listar")
    ...
    administracao.completeGeneroRelevancia(this.admin.generoRelevancia)
